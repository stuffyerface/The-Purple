...
data merge entity @s {Tags:["deployed"],custom_particle:{type:"campfire_cosy_smoke"},Age:0,Duration:100,DurationOnUse:0f,Radius:3f,RadiusPerTick:0f,RadiusOnUse:0f,ReapplicationDelay:0,NoGravity:1b,CustomName:"Deployed Smoke Bomb"}

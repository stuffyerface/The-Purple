...
execute if items entity @s[tag=in_selection_menu] main:menu_select *[minecraft:custom_data~{menu_item:true}] run return run function main:module/inventory/menu_select
...
execute if items entity @s main:inventory *[minecraft:custom_data~{id:"LOBBY_BUTTON"}] run return fail

...
# close menu
execute if items entity @s main:menu_select *[minecraft:custom_data~{id:"MENU_EXIT"}] run function main:module/inventory/menu_close
...
execute if items entity @s main:menu_select *[minecraft:custom_data~{id:"MENU_UNSELECTED_SLOT"}] run loot give @s loot main:item/menu_unselected_slot

...
execute positioned ~-0.75 ~2.3 ~ run function main:lobby/settings/game/item/element {id:"GAME_FISHING_ROD",texture:'"minecraft:fishing_rod"'}
execute positioned ~-0.75 ~1.3 ~ run function main:lobby/settings/game/item/element {id:"COBWEB",texture:'"minecraft:cobweb"'}
...
execute if score .experimental settings matches 1 positioned ~0.75 ~2.3 ~ run function main:lobby/settings/game/item/element {id:"DRACONIC_ESSENCE",texture:'"minecraft:dragon_breath"'}

tellraw @a[tag=debug] [{"text":"[Console] "},{"selector":"@s"},{"text":" swapped to Game Page 3."}]
...
# elements
execute positioned ~-1.2 ~3 ~ run function main:lobby/settings/game/total_items/element
execute positioned ~-1.2 ~2 ~ run function main:lobby/settings/game/item_spawn_percent/element
execute positioned ~-1.2 ~1 ~ run function main:lobby/settings/game/infection_time/element
...
execute positioned ~-2.03 ~0.25 ~ run function main:lobby/settings/board/element/arrow_left {"page":"game","number":"2"}
execute positioned ~-1.03 ~0.25 ~ run function main:lobby/settings/board/element/arrow_right {"page":"game","number":"4"}

...
# console log
tellraw @a[tag=debug] [{"text":"[Console] "},{"selector":"@s"},{"text":" set "},{"text":"double_tap","color":"gray"},{"text":" to "},{"score":{"name":".double_tap","objective":"settings"},"color":"green"},{"text":" right_click","color":"gray"}]

# new rock :D
summon minecraft:skeleton ~ ~ ~ {Silent:true,Invulnerable:true,DeathTime:17,DeathLootTable:"",PersistenceRequired:true,CanPickUpLoot:false,Tags:["block.rock","block.rock.base","block.rock.new"],Passengers:[{id:"minecraft:interaction",width:0.5f,height:-0.48f,response:true,Tags:["block.rock"],Passengers:[{id:"minecraft:item_display",teleport_duration:1,Tags:["block.rock"],transformation:[1f,0f,0f,0f,0f,1f,0f,0.5f,0f,0f,1f,0f,0f,0f,0f,1f]}]}],active_effects:[{id:"minecraft:invisibility",amplifier:0,duration:-1,show_particles:false}],attributes:[{id:"minecraft:attack_damage",base:0},{id:"minecraft:attack_knockback",base:0},{id:"minecraft:follow_range",base:0},{id:"minecraft:jump_strength",base:0},{id:"minecraft:knockback_resistance",base:1},{id:"minecraft:movement_speed",base:0.05},{id:"minecraft:scale",base:0.25},{id:"minecraft:step_height",base:1},{id:"minecraft:burning_time",base:0},{id:"minecraft:explosion_knockback_resistance",base:1},{id:"minecraft:movement_efficiency",base:1}]}

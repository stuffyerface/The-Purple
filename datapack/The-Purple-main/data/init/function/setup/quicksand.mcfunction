...
#execute positioned 13 15 1068 run fill ~ ~ ~ ~7 ~ ~9 command_block{auto:1b,Command:"/summon block_display ~-0.5 ~3.25 ~-0.5 {Tags:[\"trap.quicksand.block\"],block_state:{id:\"minecraft:nether_wart_block\"}}"} replace nether_wart_block
#execute positioned 13 15 1068 run fill ~ ~ ~ ~7 ~ ~9 command_block{auto:1b,Command:"/summon block_display ~-0.5 ~3.25 ~-0.5 {Tags:[\"trap.quicksand.block\"],block_state:{id:\"minecraft:black_glazed_terracotta\"}}"} replace black_glazed_terracotta

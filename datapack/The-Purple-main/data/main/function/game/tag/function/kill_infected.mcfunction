...
execute as @e[type=mannequin,tag=infected] run tag @s add spectator
execute as @e[type=mannequin,tag=infected] run function main:module/disconnect/sync/marker

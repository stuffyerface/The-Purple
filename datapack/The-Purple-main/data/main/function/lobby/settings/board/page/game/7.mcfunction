tellraw @a[tag=debug] [{"text":"[Console] "},{"selector":"@s"},{"text":" swapped to Game Page 7."}]
...
# elements
execute positioned ~-1.2 ~3 ~ run function main:lobby/settings/game/locator_bar/element
execute positioned ~-1.2 ~2 ~ run function main:lobby/settings/game/max_rounds/element
...
execute positioned ~-1.03 ~0.25 ~ run function main:lobby/settings/board/element/arrow_right {"page":"game","number":"1"}

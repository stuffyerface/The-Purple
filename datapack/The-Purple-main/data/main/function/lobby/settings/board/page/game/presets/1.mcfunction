...
execute positioned ~-1.85 ~1 ~ run function main:lobby/settings/board/element/rectangle_left {setting:'setting.presets.3',translate:"setting.purple.button.presets.3.name",fallback:"Endurance Mode",texture:'"minecraft:writable_book"',background:'"minecraft:gray_concrete"'}

...
execute if entity @s[advancements={main:triggers/settings/personal/victory_dance={rc_sleep=true}}] run function main:lobby/settings/personal/victory_dance/sleep/root
execute if entity @s[advancements={main:triggers/settings/personal/victory_dance={lc_sleep=true}}] run function main:lobby/settings/personal/victory_dance/sleep/root
execute if entity @s[advancements={main:triggers/settings/personal/victory_dance={rc_chicken_dinner=true}}] run function main:lobby/settings/personal/victory_dance/chicken_dinner/root
execute if entity @s[advancements={main:triggers/settings/personal/victory_dance={lc_chicken_dinner=true}}] run function main:lobby/settings/personal/victory_dance/chicken_dinner/root

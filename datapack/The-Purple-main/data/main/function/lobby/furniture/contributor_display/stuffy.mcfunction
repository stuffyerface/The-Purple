...
# %11$s\n%1$s %10$s %5$s%6$s%7$s%8$s%9$s%10$s %12$s\n\n%2$s\n%3$s\n%4$s\n%11$s
# 
#  1 Head/Username [{"text":"","hover_event":{"action":"show_entity","id":"minecraft:player","uuid":[754748853,1911377587,-1429384264,-1409327390]}},{"translate":"icon.purple.head.stuffy","fallback":"n","font":"purple:head"}," ",{"entity":"@n[type=text_display,tag=stuffy]","nbt":"item.components.\"minecraft:profile\".name","color":"aqua",interpret:true}]

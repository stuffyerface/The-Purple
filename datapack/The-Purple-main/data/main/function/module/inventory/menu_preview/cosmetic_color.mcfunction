...
loot replace entity @s inventory.2 loot main:item/menu_select/color_yellow
loot replace entity @s inventory.3 loot main:item/menu_select/color_lime
loot replace entity @s inventory.4 loot main:item/menu_select/color_green
loot replace entity @s inventory.5 loot main:item/menu_select/color_cyan
loot replace entity @s inventory.6 loot main:item/menu_select/color_light_blue
loot replace entity @s inventory.7 loot main:item/menu_select/color_blue
loot replace entity @s inventory.9 loot main:item/menu_select/color_purple

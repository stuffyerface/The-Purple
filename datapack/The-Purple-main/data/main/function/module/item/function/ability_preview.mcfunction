advancement revoke @s only main:triggers/items/ability_preview

# usage cooldown
execute if entity @s[scores={item.ability_preview=0..}] run return fail
scoreboard objectives add item.ability_preview dummy
scoreboard players add @s item.ability_preview 20

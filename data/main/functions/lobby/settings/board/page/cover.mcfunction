tellraw @a[tag=debug] [{"text":"[Console] "},{"text":"Main page."}]
...
# map preview
execute if score .map settings matches 1 run summon painting ~-3 ~2 ~ {Tags:["setting.map.1.preview","setting.main","settings"],variant:"minecraft:skeleton",Invulnerable:1b,Rotation:[0.0f,0.0f]}
execute if score .map settings matches 2 run summon painting ~-3 ~2 ~ {Tags:["setting.map.2.preview","setting.main","settings"],variant:"minecraft:donkey_kong",Invulnerable:1b,Rotation:[0.0f,0.0f]}
execute if score .map settings matches 3 run summon painting ~-3 ~2 ~ {Tags:["setting.map.3.preview","setting.main","settings"],variant:"minecraft:fighters",Invulnerable:1b,Rotation:[0.0f,0.0f]}

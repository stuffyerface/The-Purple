...
# summon
execute if score .randomize_horse dummy matches 1..35 run summon horse ~ ~ ~ {Tags:["victory_dance","victory_dance.horse","victory_dance.horse_new"],equipment:{saddle:{id:"minecraft:saddle",Count:1b,components:{"minecraft:tooltip_display":{hide_tooltip:true},"minecraft:enchantments":{"minecraft:binding_curse":1},"minecraft:enchantment_glint_override":false}}},drop_chances:{saddle:0.0},Invulnerable:1b,DeathLootTable:"",PersistenceRequired:1b,CanPickUpLoot:0b,Tame:1b,attributes:[{id:"minecraft:jump_strength",base:1.0},{id:"minecraft:max_health",base:30},{id:"minecraft:movement_speed",base:0.3375}]}
execute if score .randomize_horse dummy matches 36..40 run summon donkey ~ ~ ~ {Tags:["victory_dance","victory_dance.horse"],ChestedHorse:1b,Items:[{Slot:7b,id:"minecraft:player_head",Count:1b,components: {"!minecraft:attribute_modifiers": {}, "minecraft:item_name": {"fallback":"Horse","translate":"entity.minecraft.horse"}, "minecraft:lore": [{"color":"gray","fallback":"How hungry?","italic":false,"translate":"item.purple.edible_horse"}], "minecraft:food": {saturation: 20.0f, nutrition: 20, can_always_eat: 1b}, "minecraft:consumable": {on_consume_effects: [{type: "minecraft:play_sound", sound: "minecraft:entity.horse.death"}], consume_seconds: 1.0f}, "minecraft:profile": {properties: [{name: "textures", value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZTMzNWUzMTk2MTcxMzM1M2E3NjQwMWUwMGMzNDU0YjdjYTg4NWI3Nzg0ZDUyODhkMzIyNzIyMmQ5YjQ4ZDM5MyJ9fX0="}]}, "minecraft:custom_data": {id: "EDIBLE_HORSE"}}}],equipment:{saddle:{id:"minecraft:saddle",Count:1b,components:{"minecraft:tooltip_display":{hide_tooltip:true},"minecraft:enchantments":{"minecraft:binding_curse":1},"minecraft:enchantment_glint_override":false}}},drop_chances:{saddle:0.0},Invulnerable:1b,DeathLootTable:"",PersistenceRequired:1b,CanPickUpLoot:0b,Tame:1b,attributes:[{id:"minecraft:jump_strength",base:1.0},{id:"minecraft:max_health",base:30},{id:"minecraft:movement_speed",base:0.3375}]}
execute if score .randomize_horse dummy matches 41 run summon zombie_horse ~ ~ ~ {Tags:["victory_dance","victory_dance.horse"],equipment:{saddle:{id:"minecraft:saddle",Count:1b,components:{"minecraft:tooltip_display":{hide_tooltip:true},"minecraft:enchantments":{"minecraft:binding_curse":1},"minecraft:enchantment_glint_override":false}}},drop_chances:{saddle:0.0},Invulnerable:1b,DeathLootTable:"",PersistenceRequired:1b,CanPickUpLoot:0b,Tame:1b,attributes:[{id:"minecraft:jump_strength",base:1.0},{id:"minecraft:max_health",base:30},{id:"minecraft:movement_speed",base:0.3375}]}
execute if score .randomize_horse dummy matches 42 run summon skeleton_horse ~ ~ ~ {Tags:["victory_dance","victory_dance.horse"],equipment:{saddle:{id:"minecraft:saddle",Count:1b,components:{"minecraft:tooltip_display":{hide_tooltip:true},"minecraft:enchantments":{"minecraft:binding_curse":1},"minecraft:enchantment_glint_override":false}}},drop_chances:{saddle:0.0},Invulnerable:1b,DeathLootTable:"",PersistenceRequired:1b,CanPickUpLoot:0b,Tame:1b,attributes:[{id:"minecraft:jump_strength",base:1.0},{id:"minecraft:max_health",base:30},{id:"minecraft:movement_speed",base:0.3375}]}
ride @s dismount

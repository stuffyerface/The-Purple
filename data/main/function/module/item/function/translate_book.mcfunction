...
execute store result score @s dummy run data get entity @s Inventory[{components:{"minecraft:custom_data":{id:"TRANSLATE_BOOK"}}}].Slot
function main:module/item/function/translate_book_macro with entity @s Inventory[{components:{"minecraft:custom_data":{id:"TRANSLATE_BOOK"}}}].components."minecraft:writable_book_content".pages[0]

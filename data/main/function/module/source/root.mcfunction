...
execute as @a[scores={source_ability.corruption=1..}] at @s run function main:module/source/ability/corruption/timer
execute as @a[scores={source_ability.reach=0..}] at @s run function main:module/source/ability/reach/timer

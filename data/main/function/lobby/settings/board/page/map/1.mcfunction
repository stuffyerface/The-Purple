tellraw @a[tag=debug] [{"text":"[Console] "},{"selector":"@s"},{"text":" swapped to Map Page 1."}]
...
# map preview
summon painting ~1 ~2 ~ {Tags:["setting.map.1.preview","setting.map.preview","settings"],variant:"main:map/1",Invulnerable:1b,Rotation:[0.0f,0.0f]}

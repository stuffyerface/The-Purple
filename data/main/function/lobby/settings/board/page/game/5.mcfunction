tellraw @a[tag=debug] [{"text":"[Console] "},{"selector":"@s"},{"text":" swapped to Game Page 5."}]
...
# elements
execute positioned ~-1.2 ~3 ~ run function main:lobby/settings/game/round_timer/element
execute positioned ~-1.2 ~2 ~ run function main:lobby/settings/game/rope_clicks/element
execute positioned ~-1.2 ~1 ~ run function main:lobby/settings/game/corruption_despawn_time/element
...
execute positioned ~-2.03 ~0.25 ~ run function main:lobby/settings/board/element/arrow_left {"page":"game","number":"4"}
execute positioned ~-1.03 ~0.25 ~ run function main:lobby/settings/board/element/arrow_right {"page":"game","number":"6"}

...
# elements
execute positioned ~-1.2 ~3 ~ run function main:lobby/settings/game/starting_immunity/element
execute positioned ~-1.2 ~2 ~ run function main:lobby/settings/game/double_tap/element
execute positioned ~-1.2 ~1 ~ run function main:lobby/settings/game/tagback/element
...
execute positioned ~-2.03 ~0.25 ~ run function main:lobby/settings/board/element/arrow_left {"page":"game","number":"1"}
execute positioned ~-1.03 ~0.25 ~ run function main:lobby/settings/board/element/arrow_right {"page":"game","number":"3"}

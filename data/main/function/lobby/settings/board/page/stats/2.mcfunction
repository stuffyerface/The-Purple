...
execute positioned ~-1 ~0.75 ~ run function main:lobby/settings/board/element/stats_item {id1:"stat.item.safety_vest",texture1:'"minecraft:leather_chestplate",components:{"minecraft:trim": {material: "minecraft:iron", show_in_tooltip: 0b, pattern: "minecraft:host"}, "minecraft:dyed_color": {show_in_tooltip: 0b, rgb: 16742400}}',id2:"stat.item.prison_key",texture2:'"minecraft:trial_key"',id3:"stat.item.compass",texture3:'"minecraft:compass"',id4:"stat.item.freeze_time",texture4:'"minecraft:clock"',id5:"stat.item.smoke_bomb",texture5:'"minecraft:lingering_potion",components:{"minecraft:potion_contents":{custom_color:7829367}}',id6:"stat.item.antidote",texture6:'"minecraft:potion",components:{"minecraft:potion_contents":{custom_color:16711680}}'}
execute positioned ~1 ~0.75 ~ run function main:lobby/settings/board/element/stats_item {id1:"stat.item.wind_charge",texture1:'"minecraft:wind_charge"',id2:"stat.item.revival_potion",texture2:'"minecraft:splash_potion",components:{"minecraft:potion_contents":{custom_color:16768256}}',id3:"",texture3:'"minecraft:air"',id4:"",texture4:'"minecraft:air"',id5:"",texture5:'"minecraft:air"',id6:"",texture6:'"minecraft:air"'}

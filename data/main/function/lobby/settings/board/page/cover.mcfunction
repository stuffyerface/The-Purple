...
execute if score .map settings matches 0 run summon text_display ~-2 ~0.6 ~ {Tags:["setting.main.map_name","setting.main.map_name.0","settings"],text:'[{"translate":"setting.purple.title.map_0","fallback":"Map #0","color":"gray"}]',shadow:1b,background:0,alignment:"center",transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.7f,0.7f,0.7f]}}
execute if score .map settings matches 1 run summon text_display ~-2 ~0.6 ~ {Tags:["setting.main.map_name","setting.main.map_name.1","settings"],text:'[{"translate":"setting.purple.title.map_1","fallback":"Map #1","color":"gray"}]',shadow:1b,background:0,alignment:"center",transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.7f,0.7f,0.7f]}}
execute if score .map settings matches 2 run summon text_display ~-2 ~0.6 ~ {Tags:["setting.main.map_name","setting.main.map_name.2","settings"],text:'[{"translate":"setting.purple.title.map_2","fallback":"Map #2","color":"gray"}]',shadow:1b,background:0,alignment:"center",transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.7f,0.7f,0.7f]}}
execute if score .map settings matches 3 run summon text_display ~-2 ~0.6 ~ {Tags:["setting.main.map_name","setting.main.map_name.3","settings"],text:'[{"translate":"setting.purple.title.map_3","fallback":"Map #3","color":"gray"}]',shadow:1b,background:0,alignment:"center",transformation:{left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f],translation:[0f,0f,0f],scale:[0.7f,0.7f,0.7f]}}

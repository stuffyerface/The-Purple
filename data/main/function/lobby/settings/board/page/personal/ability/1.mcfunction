...
# elements
execute positioned ~-1.85 ~3.1 ~ run function main:lobby/settings/board/element/rectangle_left {setting:'setting.source_ability.speed',translate:"setting.purple.button.source_ability.speed.name",fallback:"Speed Burst",texture:'"minecraft:potion",components:{"minecraft:potion_contents":{custom_color:61183}}',background:'"minecraft:gray_concrete"'}

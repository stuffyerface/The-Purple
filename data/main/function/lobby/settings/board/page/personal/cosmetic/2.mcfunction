...
# elements
execute positioned ~0.2 ~3.1 ~ run function main:lobby/settings/board/element/rectangle_left {setting:'setting.victory_dance.fireworks',translate:"setting.purple.button.victory_dance.fireworks.name",fallback:"Fireworks",texture:'"minecraft:firework_rocket"',background:'"minecraft:gray_concrete"'}
execute positioned ~0.2 ~2.1 ~ run function main:lobby/settings/board/element/rectangle_left {setting:'setting.victory_dance.rainbow_sheep',translate:"setting.purple.button.victory_dance.rainbow_sheep.name",fallback:"Rainbow Sheep",texture:'"minecraft:player_head", components: {"minecraft:profile": {properties: [{name: "textures", value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZTA2OGQzMzJhYWJlOWI4Nzc0MGIzZmFkZjU1NzI0NTJiZWY2NzlmN2FhNTdlOGVjMWUwMTc2Nzg5NzFhZTgwNyJ9fX0="}]}}',background:'"minecraft:gray_concrete"'}
execute positioned ~0.2 ~1.1 ~ run function main:lobby/settings/board/element/rectangle_left {setting:'setting.victory_dance.horse',translate:"setting.purple.button.victory_dance.horse.name",fallback:"Horserider",texture:'"minecraft:player_head", components: {"minecraft:profile": {properties: [{name: "textures", value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZTMzNWUzMTk2MTcxMzM1M2E3NjQwMWUwMGMzNDU0YjdjYTg4NWI3Nzg0ZDUyODhkMzIyNzIyMmQ5YjQ4ZDM5MyJ9fX0="}]}}',background:'"minecraft:gray_concrete"'}
# usually -1.85

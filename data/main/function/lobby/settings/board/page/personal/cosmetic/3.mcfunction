...
# elements
execute positioned ~ ~3.1 ~ run function main:lobby/settings/board/element/rectangle_left {setting:'setting.death_effect.explode',translate:"setting.purple.button.death_effect.explode.name",fallback:"Explosion",texture:'"minecraft:tnt"',background:'"minecraft:gray_concrete"'}
execute positioned ~ ~2.1 ~ run function main:lobby/settings/board/element/rectangle_left {setting:'setting.death_effect.shrink',translate:"setting.purple.button.death_effect.shrink.name",fallback:"Shrink",texture:'"minecraft:player_head",components:{"minecraft:profile": {properties: [{name: "textures", value: "eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZmY5NmI4ZDAxZjU4MzVlZDM4YWZkNDUzMDIyOGQwYjVhYmI3ZDQ1YTM1NTUxOWVhNjgwYzQwZmZjYTMyZWRmMiJ9fX0="}]}}',background:'"minecraft:gray_concrete"'}
execute positioned ~ ~1.1 ~ run function main:lobby/settings/board/element/rectangle_left {setting:'setting.death_effect.grave',translate:"setting.purple.button.death_effect.grave.name",fallback:"Gravestone",texture:'"minecraft:skeleton_skull"',background:'"minecraft:gray_concrete"'}
# usually -1.85

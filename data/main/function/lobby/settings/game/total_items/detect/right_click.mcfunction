...
execute if score .total_items settings matches ..0 run scoreboard players set .total_items settings 11
execute if score .total_items settings matches 0.. run scoreboard players remove .total_items settings 1
execute if score .total_items settings matches 12.. run scoreboard players set .total_items settings 0

...
# last updated by
summon item_display ~4.4 ~0.4 ~-0.005 {Tags:["setting.game.round_timer-updater","settings"],billboard:"fixed",item:{id:"minecraft:player_head",count:1},transformation:[1.0000f,0.0000f,0.0000f,0.0000f,0.0000f,1.0000f,0.0000f,0.2500f,0.0000f,0.0000f,-0.0750f,0.0000f,0.0000f,0.0000f,0.0000f,1.5000f]}

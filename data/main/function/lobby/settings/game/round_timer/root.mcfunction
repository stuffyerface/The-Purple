...
# console log
tellraw @a[tag=debug] [{"text":"[Console] "},{"selector":"@s"},{"text":" set "},{"text":"round_timer","color":"gray"},{"text":" to "},{"score":{"name":".round_timer","objective":"settings"},"color":"green"},{"text":" click","color":"gray"}]

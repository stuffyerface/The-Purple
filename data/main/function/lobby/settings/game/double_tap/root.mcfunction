...
execute as @e[type=text_display,tag=setting.game.double_tap] if score .double_tap settings matches 1 run data merge entity @s {text:'[{"text":"Double Tap? "},{"text":"Off","color":"red"},{"strikethrough":true,"text":"\\n                                ","color":"dark_gray"}]'}
execute as @e[type=text_display,tag=setting.game.double_tap] if score .double_tap settings matches 2 run data merge entity @s {text:'[{"text":"Double Tap? "},{"text":"On","color":"green"},{"strikethrough":true,"text":"\\n                                ","color":"dark_gray"}]'}
execute as @e[type=text_display,tag=setting.game.double_tap] if score .double_tap settings matches 3.. run data merge entity @s {text:'[{"text":"Double Tap? "},{"color":"green","score":{"name":".double_tap","objective":"settings"}},{"text":" Hits"},{"strikethrough":true,"text":"\\n                                ","color":"dark_gray"}]'}

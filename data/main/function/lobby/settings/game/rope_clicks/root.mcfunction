...
execute as @e[type=text_display,tag=setting.game.rope_clicks] run data merge entity @s {text:'[{"text":"Rope Clicks: "},{"color":"green","score":{"name":".rope_clicks","objective":"settings"}},{"text":"s"},{"strikethrough":true,"text":"\\n                                ","color":"dark_gray"}]'}

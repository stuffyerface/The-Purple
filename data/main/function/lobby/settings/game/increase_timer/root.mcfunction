...
execute if score .increase_timer settings matches 1.. as @e[type=text_display,tag=setting.game.increase_timer] run data merge entity @s {text:'[{"text":"Tags Raise Timer: "},{"color":"green","score":{"name":".increase_timer","objective":"settings"}},{"text":"s"},{"strikethrough":true,"text":"\\n                                ","color":"dark_gray"}]'}
execute if score .increase_timer settings matches ..0 as @e[type=text_display,tag=setting.game.increase_timer] run data merge entity @s {text:'[{"text":"Tags Raise Timer: "},{"text":"Off","color":"red"},{"strikethrough":true,"text":"\\n                                ","color":"dark_gray"}]'}

...
execute as @e[type=text_display,tag=setting.game.offline_time] run data merge entity @s {text:'[{"text":"Offline Time: "},{"color":"green","score":{"name":".offline_time","objective":"settings"}},{"text":" ticks"},{"strikethrough":true,"text":"\\n                                ","color":"dark_gray"}]'}

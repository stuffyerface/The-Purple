...
execute as @e[type=text_display,tag=setting.game.tagback] if score .tagback settings matches ..-1 run data merge entity @s {text:'[{"text":"Allow Tagbacks? "},{"text":"Never","color":"red"},{"strikethrough":true,"text":"\\n                                ","color":"dark_gray"}]'}
execute as @e[type=text_display,tag=setting.game.tagback] if score .tagback settings matches 0 run data merge entity @s {text:'[{"text":"Allow Tagbacks? "},{"text":"Always","color":"green"},{"strikethrough":true,"text":"\\n                                ","color":"dark_gray"}]'}
